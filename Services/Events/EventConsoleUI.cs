...
namespace Eventify.Services.Events
{
    public class EventConsoleUI
    {
        ...
        private void AddNewEvent()
        {
            ...
            AnsiConsole.MarkupLine("[green]Wydarzenie zostało dodane pomyślnie![/]");
            Console.ReadKey();
        }
        ...
        public void DisplayAllEvents()
        {
            ...
            {
                AnsiConsole.MarkupLine("[yellow]Brak dostępnych wydarzeń.[/]");
            }
            else
            {
                var table = new Table()
        ...
        private void DeleteEvent()
        {
            ...
            if (events.Count == 0)
            {
                AnsiConsole.MarkupLine("[yellow]Brak wydarzeń do usunięcia.[/]");
                Console.ReadKey();
                return;
            }
            ...
            if (AnsiConsole.Confirm($"Czy na pewno chcesz usunąć wydarzenie [red]'{selectedEvent}'[/]?"))
            {
                ...
                {
                    AnsiConsole.MarkupLine("[green]Wydarzenie zostało usunięte pomyślnie![/]");
                }
                else
                {
                    AnsiConsole.MarkupLine("[red]Nie udało się usunąć wydarzenia.[/]");
                }
            }
            else
            {
